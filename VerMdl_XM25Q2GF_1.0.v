...
`define SIZE              32'd2147483648  // 2Gbit 1024*1024*512     
`define BLOCK_NUM	    4096      //number of block 
...
`define SIGNATRUE          8'h1b          // electronic signature   CMD=AB ID7-ID0               
`define manufacturerID     8'h0b         // Manufacturer ID
`define memtype            8'h60        // memorytype   ID15-ID8
`define density            8'h1c       // memory density 16Mbits  ID7-ID0                                
`define BIT_TO_CODE_MEM    28         // number of bit to code a 128Mbits memory                       
...
`define TCE    200000     // chip erase cycle time 
...
//////////////////////////////////////////////////////////////////////////////
`timescale 1ns/1ps
module xm55q2gf(cs,sclk,si,wp,hold,so,ecs);
   input cs;
   input sclk;
...
initial
   begin
      ...
      for(bit[31:0] ii = 0; ii <= 268435456   ; ii = ii + 1)   //array data initialization 
      begin
         content[ii] = 8'b11111111 ; 
      end
...
module internal_logic (       c,   d,      w, s, hold, data_to_read, q,        data_to_write, page_add_index, add_mem, suspend_add, suspend_enable, suspend_pp, suspend_ber32 , suspend_ber64 , suspend_ser, resume_enable, write_op, read_op, qpi_wrap_read, cer_enable, ber32_enable, ber64_enable, ser_enable, add_pp_enable, pp_enable,write_data_request, read_enable, read_data_request, oen, thold_readquad,  
  ...
  wire bpbit;
   ...
   reg [(`LSB_TO_CODE_PAGE -1) :0]  lsb_adress; 
	...
	reg [11:0] address_IB_lock;
        reg [11:0] address_IB_read;
...
///////////////////////////
	 //////////////third address byte
		...
		extended_addr = {4'b0,A27,A26, A25, A24};
...
//output data
 ...
 always 
   ...
   always 
	...
	if(adress_1[1:0]==0 && !read_uid)begin
	    if(qpim)
	    begin
...
always @(select_ok)
	begin
		...
		(cpt == 0)) || ((byte_cpt == 1) && (((cpt == 7) && !qpim) || ((cpt ==1) && qpim)))) && byte_ok && ( wr_configuration_reg ))) && (!vwsr_enable) && (!only_rdsr))    
      	...
      	if ((((byte_cpt == 3) || ((byte_cpt == 2) && ((cpt == 7) && !qpim || (cpt ==1) && qpim) && byte_ok)) || ((byte_cpt == 2) || ((byte_cpt == 1) && ((cpt == 7) && !qpim || (cpt ==1) && qpim) && byte_ok))) && (wrsr_l || wrsr_m || wrsr_h) && (vwsr_enable) && (!only_rdsr))     
      	begin
         	if (!select_ok) 
         	begin
                  wrsr_l <= `FALSE ;
	...
	if(T_B == 1'b0) //5109 cmlin no T_B bit
	  begin 
	    casez ( bp )
      	      5'b00001 : 
      	      begin
      	         if( (cut_add >= 32'hfff0000) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	      ...
      	      5'b00010 : 
      	      begin
      	         if( (cut_add >= 32'hffe0000) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	      ...
      	      5'b00011 : 
      	      begin
      	         if( (cut_add >= 32'hffc0000) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	      ...
      	      5'b00100 : 
      	      begin
      	         if( (cut_add >= 32'hff80000) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	     ...
      	     5'b00101 : 
      	      begin
      	         if( (cut_add >= 32'hff00000) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	    ...
      	    5'b00110 : 
	      begin
      	         if( (cut_add >= 32'hfe00000) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	      ...
      	      5'b00111 : 
      	      begin
      	         if( (cut_add >= 32'hfc00000) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	       ...
      	       5'b01000 : 
      	      begin
      	         if( (cut_add >= 32'hf800000) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	      ...
      	      5'b01001 : 
      	      begin
      	         if( (cut_add >= 32'hf000000) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
	      ...
	      5'b01010 : 
      	      begin
      	         if( (cut_add >= 32'he000000) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
	      ...
	      5'b01011 : 
      	      begin
      	         if( (cut_add >= 32'hc000000) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
	      ...
	      5'b01100 : 
      	      begin
      	         if( (cut_add >= 32'h8000000) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
		  ...
		  5'b11100 : 
      	      begin
      	         if( (cut_add >= 32'h0) && (cut_add <= 32'h7ffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
		  ...
		  5'b?1101,  5'b?111?: 
      	      begin
      	         if( (cut_add >= 32'h0) && (cut_add <= 32'hfffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
