...
set_svf ../dc_noICG_260206/output/ctrl_fsm.svf

read_db /home/nnge/Projects/SMIC/smic_90bcd/ReMTP/Hynitron/libs/scc90nbcd_hd_rvt_ss_v1p35_125c_basic.db

read_verilog -r ../rtl/rstn_sync.v
read_verilog -r ../rtl/sync_2stage.v
read_verilog -r ../rtl/mrd_vfy.v
read_verilog -r ../rtl/ctrl_fsm_core.v
read_verilog -r ../rtl/ctrl_fsm.v
set_top ctrl_fsm

read_verilog -i ../dc_noICG_260206/output/ctrl_fsm.synthesis.v
set_top ctrl_fsm
