...
`define SIZE              32'd1073741824  // 1Gbit 1024*1024*1024     
`define BLOCK_NUM	   2048       //number of block 
...
`define SIGNATRUE          8'h1a          // electronic signature   CMD=AB ID7-ID0               
`define manufacturerID     8'h0b         // Manufacturer ID
`define memtype            8'h60        // memorytype   ID15-ID8
`define density            8'h1b       // memory density 16Mbits  ID7-ID0                                
`define BIT_TO_CODE_MEM    27         // number of bit to code a 128Mbits memory                       
...
//////////////////////////////////////////////////////////////////////////////
`timescale 1ns/1ps
module xm55q1gf(cs,sclk,si,wp,hold,so,ecs);
   input cs;
   input sclk;
...
initial
   begin
      ...
      for(bit[31:0]  i = 0; i <= (`TOP_MEM); i = i + 1)   //array data initialization 
      begin
...
module internal_logic (       c,   d,      w, s, hold, data_to_read, q,        data_to_write, page_add_index, add_mem, suspend_add, suspend_enable, suspend_pp, suspend_ber32 , suspend_ber64 , suspend_ser, resume_enable, write_op, read_op, qpi_wrap_read, cer_enable, ber32_enable, ber64_enable, ser_enable, add_pp_enable, pp_enable,write_data_request, read_enable, read_data_request, oen, thold_readquad,  
  ...
  wire bpbit;
   ...
   reg [(`LSB_TO_CODE_PAGE -1) :0]  lsb_adress; 
	...
	reg [10:0] address_IB_lock;
        reg [10:0] address_IB_read;
...
///////////////////////////
	 //////////////third address byte
		...
		extended_addr = {5'b0, A26,A25, A24};
	...
	if(T_B == 1'b0) //5109 cmlin no T_B bit
	  begin 
	    casez ( bp )
      	      5'b00001 : 
      	      begin
      	         if( (cut_add >= 32'h7ff0000) && (cut_add <= 32'h7ffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	      ...
      	      5'b00010 : 
      	      begin
      	         if( (cut_add >= 32'h7fe0000) && (cut_add <= 32'h7ffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	      ...
      	      5'b00011 : 
      	      begin
      	         if( (cut_add >= 32'h7fc0000) && (cut_add <= 32'h7ffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	      ...
      	      5'b00100 : 
      	      begin
      	         if( (cut_add >= 32'h7f80000) && (cut_add <= 32'h7ffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	     ...
      	     5'b00101 : 
      	      begin
      	         if( (cut_add >= 32'h7f00000) && (cut_add <= 32'h7ffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	    ...
      	    5'b00110 : 
	      begin
      	         if( (cut_add >= 32'h7e00000) && (cut_add <= 32'h7ffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	      ...
      	      5'b00111 : 
      	      begin
      	         if( (cut_add >= 32'h7c00000) && (cut_add <= 32'h7ffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	       ...
      	       5'b01000 : 
      	      begin
      	         if( (cut_add >= 32'h7800000) && (cut_add <= 32'h7ffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
      	      ...
      	      5'b01001 : 
      	      begin
      	         if( (cut_add >= 32'h7000000) && (cut_add <= 32'h7ffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
	      ...
	      5'b01010 : 
      	      begin
      	         if( (cut_add >= 32'h6000000) && (cut_add <= 32'h7ffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
	      ...
	      5'b01011 : 
      	      begin
      	         if( (cut_add >= 32'h4000000) && (cut_add <= 32'h7ffffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
	      ...
	      5'b10001 : 
      	      begin
      	         if( (cut_add >= 32'h0) && (cut_add <= 32'h0ffff) )
      	          begin
      	             bpbit_reg<= `TRUE;
      	           end
