module ctrl_if(
    ...
    output reg write_SR_shadow_signal,
    output reg write_SR_signal,
    output reg write_array_signal,
    output reg read_array_signal,
    output reg read_SR_signal,
    output reg set_wel,
    output reg clear_wel,
    output reg clear_FSR,
    output reg read_FSR_signal,
    output reg erase_sector_signal,
    output reg erase_block32_signal,
    output reg erase_block64_signal,
    output reg erase_chip_signal,
    output reg pes_signal,
    output reg per_signal,
    output reg data_crc_signal,
    output reg global_block_sector_lock_signal,
    output reg global_block_sector_unlock_signal,
    output reg write_VCR_signal,
    output reg read_VCR_signal,
    output reg write_NVCR_signal,
    output reg read_NVCR_signal,
    output reg read_manuid_devid_signal,
    output reg rdid_signal,
    output reg read_devid_signal,
    output reg read_itcrcr_signal,
    output reg write_EAR_signal,
    output reg read_EAR_signal,
    output reg write_VLR_signal,
    output reg read_VLR_signal,
    output reg read_NVLR_signal,
    output reg set_NVLR_signal,
    output reg clear_all_NVLR_signal,
    output reg set_ads,
    output reg clear_ads,
    output reg write_sec_reg_signal,
    output reg erase_sec_reg_signal,
    output reg read_sec_reg_signal,
    output reg read_uid_signal,
    output reg rst_all,
    output reg exit_dpd_signal,
    ...
    parameter decode_spi            = 5'd2;
    parameter drive_standard        = 5'd3;
    parameter drive_dual            = 5'd4;
    parameter drive_quad            = 5'd5;
    parameter drive_dtr_dual        = 5'd6;
    parameter drive_dtr_quad        = 5'd7;
    ...
    always@(*) begin
        ...
        case(current_state)
            ...
            drive_dtr_dual: begin
                // to do : 高速接口双线双边沿驱动输出；
            end

            drive_dtr_quad : begin
                // to do : 高速接口四线双边沿驱动输出；
            end
